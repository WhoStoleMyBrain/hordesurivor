...
class HudStatsContent extends StatelessWidget {
  const HudStatsContent({
    super.key,
            ...
            children: [
              ...
              if (false) ...[
                Wrap(
                  ...
                  runSpacing: 6,
                  children: [
                    for (final badge in tagBadgesForTags(hudState.buildTags))
                      TagBadge(data: badge),
                  ],
                ),
              ...
              if (hudState.stageDuration > 0) ...[
                ...
                if (hudState.sectionNote != null &&
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 2),
                    child: Text(hudState.sectionNote!, style: mutedStyle),
                  ),
              ],
              ...
              if (hudState.showPerformance && onExitStressTest != null) ...[
                const SizedBox(height: 6),
                TextButton(
